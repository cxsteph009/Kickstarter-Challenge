...
There were several challenges and difficulties faced in the analysis, such as Unix timestamps, incorrectly formatted columns, and adding a subcategory. All timestamps were converted to Short Date format. All formatting updated. Defined category and created subcategory.  
Countless graphs and tables could be created to take a deeper look into the data, such as comparing data between subcategories or comparing Outcomes Based on country.
